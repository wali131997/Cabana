...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 05, 2021 at 09:49 PM
...
--
-- Table structure for table `admins_meta`
--

CREATE TABLE `admins_meta` (
...
--
-- Dumping data for table `admins_meta`
--

INSERT INTO `admins_meta` (`id`, `user_id`, `token`, `user_ip`, `token_validation`, `created_at`, `updated_at`) VALUES
(18, '9', '$2y$10$DsX829FmJdM7mAE0S402rOzcCw2cCyBlWss89fDT9aqje4r01GfiS', '127.0.0.1', '23-04-2021 13:04:33pm', '2021-04-23 08:19:33', '2021-04-23 08:19:33'),
(19, '1', '$2y$10$c2alpbbZ1qt34DPRDgms1ONBQy3dUkxdwBOTnm1021nN0779CJ/s2', '127.0.0.1', '24-04-2021 10:04:48am', '2021-04-24 05:28:48', '2021-04-24 05:28:48');
...
CREATE TABLE `promotions` (
  ...
  `title` text NOT NULL,
  `link` text NOT NULL,
  `type` int(11) NOT NULL COMMENT '1: All Countries',
...
INSERT INTO `promotions` (`id`, `title`, `link`, `type`, `status`, `countries`, `created_at`, `updated_at`) VALUES
(1, 'GET 35% OF BONUS AS TRADING ACCOUNT DEPOSIT', '/newPromotion', 2, 1, '[{\"id\":2,\"iso\":\"AL\",\"name\":\"Albania\"},{\"id\":4,\"iso\":\"AS\",\"name\":\"American Samoa\"},{\"id\":5,\"iso\":\"AD\",\"name\":\"Andorra\"}]', '2021-07-05 14:19:43', '2021-07-05 14:19:43'),
(2, 'GET 35% OF BONUS AS TRADING ACCOUNT DEPOSIT', '/newPromotion', 2, 1, '[{\"id\":2,\"iso\":\"AL\",\"name\":\"Albania\"},{\"id\":4,\"iso\":\"AS\",\"name\":\"American Samoa\"},{\"id\":5,\"iso\":\"AD\",\"name\":\"Andorra\"},{\"id\":162,\"iso\":\"PK\",\"name\":\"Pakistan\"}]', '2021-07-05 14:46:18', '2021-07-05 14:46:18');
...
--
-- Indexes for table `admins_meta`
--
ALTER TABLE `admins_meta`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `admins_meta`
--
ALTER TABLE `admins_meta`
