...
class EditPromotion extends Component {
    ...
    componentDidMount(){
        ...
        Axios.post('/api/get_promotion_by_id',{id:this.props.match.params.id}).then(res=>{
            this.setState({
    ...
    AddPromotion(){
        Axios.post('/api/update_promotion',this.state).then(res=>{
            if(res.data.status == 200){
                Swal.fire({
                    position: 'top-end',
                    icon: 'success',
                    title: 'Promotion Updated Successfull',
        ...
        return (
            <div className="container">
                <div className="top_section_title_div">
                    <h2 className="section_title">Update Promotion</h2>
                </div>
                <div >
                    <div className="card p-3 content_card_div mt-4 mb-5">
                        <div className="row col-md-12">
                            ...
                            <div class="form-group input_div col-md-6">
                                ...
                                <input value={this.state.link }   onChange={this.link.bind(this)}  type="text" class="form-control " id="exampleInputEmail1" aria-describedby="emailHelp" />
                            </div>
                        </div>
                        <div className="row col-md-12">
                            <div class="form-group input_div col-md-6">
                            ...
                            <div class="form-group input_div col-md-6">
                                ...
                                <select value={this.state.status }  value={this.state.status}  onChange={this.status.bind(this)} class="form-control " id="exampleInputEmail1" aria-describedby="emailHelp" >
