...
class AddSlider extends Component {
    ...
    AddPromotion(){
        Axios.post('/api/add_slider',this.state).then(res=>{
            console.log(res);
                    ...
                    <div className="card p-3 content_card_div mt-4 mb-5">
                        <div className="row col-md-12">
                            ...
                            <div class="form-group input_div col-md-12">
                                ...
                                <textarea style={{width:'100%',height:'300px'}}  onChange={this.content.bind(this)}  type="text" class="form-control " id="exampleInputEmail1" aria-describedby="emailHelp" />
                            </div>
