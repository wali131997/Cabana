    ...
    return (
      <>
        {/* <div className="col-4 px-0 standardM compareAccountDetail">
               ...
               <h4 className="compareAccountInfoTitle text-black ">MICRO</h4>
            ...
            <h2 className="compareAccountNorMobText mt-3">USD</h2>
              ...
              <p className="compareAccountNorMobText">Spread: From 2.5</p>
        ...
        <div className="col-6 px-0 standardM compareAccountDetail">
          <div className="compareAccountBgM borderRightBlack">
            <h4 className="compareAccountInfoTitle text-black ">Cent <br /> Account</h4>
            <p className="compareAccountPrice text-black">$10/min</p>
          ...
          <h4 className="title d-inine "><span className="opacityZero">S</span></h4>
          <p className="compareAccountNorMobText">From 20/30/200/180</p>
        ...
        {/* <div className="col-4 px-0 standardM compareAccountDetail">
               ...
               <h4 className="compareAccountInfoTitle text-black  ">Micro Account</h4>
               <p className="compareAccountPrice text-black">$10/min</p>
            ...
            <h2 className="compareAccountNorMobText mt-3">USD</h2>
             ...
             <h2 className="compareAccountNorMobText">  Market Execution</h2>
              ...
              <button onClick={()=>{ window.open('https://portal.aurummarkets.com/register/','_self')}} className="btnPrimaryPink2  mt-4  ">
                GET STARTED
              </button>
        ...
        <div className="col-6 px-0 standardM compareAccountDetail">
          <div className="compareAccountBgM borderRightBlack">
            <h4 className="compareAccountInfoTitle text-black ">Standerd Account</h4>
