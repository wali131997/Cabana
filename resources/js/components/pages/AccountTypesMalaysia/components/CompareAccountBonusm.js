...
class CompareAccountBonusm extends Component {
    render() {
        return (
           <>
           <div className="col-6 px-0 standardM compareAccountDetail">
            ...
            <h2 className="compareAccountNorMobText mt-3">USD</h2>
              ...
              <h4 className="title d-inine "><span className="opacityZero">Spread </span></h4>
              <p className="compareAccountNorMobText">From 16/25/150/180</p>
              ...
              <h2 className="compareAccountNorMobText"> $0</h2>
              <h4 className="title d-inine "><span className="opacityZero">LEVERAGE</span></h4>
              <h2 className="compareAccountNorMobText"> Fixed 1:300 for currencies</h2>
           ...
           <div className="col-6 px-0 standardM compareAccountDetail">
            ...
            <h2 className="compareAccountNorMobText mt-3">USD</h2>
              ...
              <p className="compareAccountNorMobText">From 2
</p>
              <h4 className="title title2 d-inine "><span className="">Spread (Gold/SP/NQ/DJ)</span></h4>
              <p className="compareAccountNorMobText">From 20/30/200/180
</p>
              ...
              <h2 className="compareAccountNorMobText"> Up to 1:300 for currencies</h2>
             ...
             <h2 className="compareAccountNorMobText"> 10000</h2>
           ...
           {/* <div className="col-4 px-0 standardM compareAccountDetail">
            ...
            <h2 className="compareAccountNorMobText mt-3">USD</h2>
              ...
              <h4 className="title d-inine "><span className="opacityZero">Leverage</span></h4>
              <h2 className="compareAccountNorMobText"> Fixed 1:1000 for currencies</h2>
              <h4 className="title d-inine "><span className="opacityZero">Instruments</span></h4>
...
export default CompareAccountBonusm;
