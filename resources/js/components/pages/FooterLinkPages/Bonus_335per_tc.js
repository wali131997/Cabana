...
const Bonus_335per_tc = () => {
    return (
        <div>
            <HeroSection title="35% Trading Bonus" text="Aurum Markets brings a whopping 35% trading bonus (up to $1000) to your trading account deposit." />
            <div className=' footerLinkPage'>
                <div className="basicRow">
                    <div className='basciText'>
                        <h2 className="text-center">Terms & Conditions</h2>
                        <br></br>
                        1.	Subject to, and without prejudice to, all other Business Terms and Policies, the offer is available to Aurum Markets Clients who have satisfied the Eligibility Criteria for the offer (“Eligible Clients”) as set out in the sections following hereinafter.
                        <br></br>  <br></br>
                        ...
                        <br></br>  <br></br>
                        3.	The Aurum Markets “35% Trading Bonus” Terms & Conditions are applicable to all Clients of Aurum Markets who are approved, are eligible to trade and:
                        <br></br>
                        •	Run a live trading account  with Aurum markets as per the applicable Minimum Account Activation Deposit and/or other requirements of Aurum Markets, and subject to the present 35% Trading Bonus T&Cs;
                        <br></br>
                        ...
                        <br></br>  <br></br>12.	Deposit, Withdrawal and Trade holding time is in conjunction with the trading terms of Aurum Markets.
                        ...
                        <br></br>  <br></br>15.	You may receive a call from Your Account Manager at Aurum Markets for the verification process
                        <br></br>  <br></br>16.	Aurum Markets may cancel a client’s bonus at any time without prior notification.
                        <br></br>  <br></br>17.	Any situation not described in these rules shall be subject to the Company’s Decision.
                        <br></br>  <br></br>18.	Aurum Markets reserves the right to change, update or cancel this promotion. The client will be notified via email or will be announced on the Website’s promotion menu.
                        <br></br>  <br></br>19.	Offer is valid for only in African Countries.
                        <br></br>  <br></br>20.	In the event of any dispute or misinterpretation of the above applicable 35% Trading Bonus terms & conditions, such dispute or misinterpretation shall be resolved by Aurum Markets, acting in good faith and as it shall, in its sole and absolute discretion, deem fit and proper. Aurum Markets’s decision shall be final and binding.
                        <br></br>  <br></br>21.	Aurum Markets has the right to disqualify any client who has accepted the current terms & conditions if:
                        <br></br>•	A breach of these terms & conditions and/or of any term of the Operative Agreements occurs;
                        <br></br>•	Aurum Markets has reasonable grounds to believe a misuse of the 35% Trading Bonus terms & conditions;
                        ...
                        <br></br>  <br></br>22.	Aurum Markets has the right to alter the terms & conditions at its discretion. Aurum Markets may suspend or terminate the current terms & conditions if a situation arises where the conditions are unfair for more participants. Aurum Markets has the right to suspend or terminate the current terms & conditions if its continuation is rendered impossible due to extraordinary circumstances beyond the control of Aurum Markets (natural disasters, political conflicts etc.).
