...
const FiftypercentBonus = () => {
    return (
        <div>
            ...
            <div className='container fifty_per_page'>
                <div className='row mt-5'>
                    <div className='col-md-12'>
                        <h4 className='text-bold title title2 text-center text-dark'>CLAIM YOUR  BONUS IN 4 EASY STEPS</h4>
                        <div className='row mt-5'>
            ...
            <div className='row bgpurple mt-5'>
                <div className='col-md-6'>
                    <div className='row'>
                        ...
                        <div className='col-md-10'>
                            <img style={{ width: '70%' }} src='/assets/images/49-dollar-png-image.png'></img>
                        </div>
                    </div>
                </div>
                <div className='col-md-6'>
            ...
            <div className='container mt-5'>
                <div className='row'>
                    ...
                    <div className='col-md-6' >
                        ...
                        <h4>
                            <span className='title titlelg text-bold'>2</span>  Multiply Your Profit Potential  2,000 Times.
                        </h4>
                        <h4>
                            <span className='title titlelg text-bold'>3</span> Open Positions of Up to 750 Times GreaterThan Your Initial InveOpen Positions of Up to 750 Times GreaterThan Your Initial Inve
                        </h4>
                    </div>
                </div>
            </div>

            <div className='bgpurple mt-5'>
...
export default FiftypercentBonus;
