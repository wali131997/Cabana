        ...
        <div>
            ...
            <div className='container mt-5 px-5'>
                ...
                <div className='row '>
                    ...
                    <div className='col-md-2 d-flex  px-0 m-0 mt-2 ' style={{ gap: '1' }}>
                        <img style={{ width: '50px', height: '50px' }} src='/assets/images/dubaipromotion/Register.png'></img>
                        <h2 className='text-bold mt-3  px-2  title ' style={{ fontSize: '22px' }}>Sign up</h2>
                    </div>
                    <div className='col-md-4   d-flex  px-0 m-0 mt-2' style={{ gap: '1' }}>
                        <img style={{ width: '50px', height: '50px' }} src='/assets/images/dubaipromotion/Deposit.png'></img>
                        <h2 className='text-bold mt-3 title px-2 ' style={{ fontSize: '22px' }}>Make a minimum deposit</h2>
                    </div>
                    <div className='col-md-4    d-flex  px-0 m-0 mt-2' style={{ gap: '1' }}>
                        <img style={{ width: '50px', height: '50px' }} src='/assets/images/dubaipromotion/Dollar.png'></img>
                        <h2 className='text-bold mt-2 title  px-2  ' style={{ fontSize: '22px' }}>Start trading to win Dubai trip</h2>
                    </div>
                ...
                <div className='container'>
                    ...
                    <div className=''>
                        <ul>
                            ...
                            <ul>
                                <li>The Promotion Period begins on Feb 15th 2024 and concludes on May 15th 2024. All eligible deposits and trading activities must occur within this speciﬁed timeframe.
                                </li></ul>
