   ...
   <div className='title title2'>Promotion</div>
        ...
        <div className='container'>
            ...
            <div className='row mt-5 mb-5'>
                ...
                <h1 style={{fontSize:'24px'}} className="text-left mt4title p-0">Cabana Capital introduce exclusive Welcome Bonus promotional offer for its clients in Malaysia.
Sign up with Cabana Capitals and get $50 Welcome Bonus as credit for one month. </h1>
<h4 className='text-bold title_loss2'>
                    		Welcome Bonus is available eligible clients of Cabana Capitals. Clients meet the criteria set forth
...
account at Cabana Capitals with at least $50 or above in accordance with the rules set
herein	</h4>
                    <h4 className='text-bold title_loss2'>
...
be transferred between trading accounts with in Cabana Capitals.	</h4>
                    <h4 className='text-bold title_loss2'>
...
credit. After one month credit will be removed from Welcome Bonus Account.</h4>
                    ...
                    <h4 className='text-bold title_loss2'>
                    <strong>8.</strong>		. Hedging trading positions internally (using other trading accounts held with Cabana Capitals)
...
Cabana Capitals and/or any and all transactions carried and/or profits garnered therein.</h4>
                    <h4 className='text-bold title_loss2'>
                    <strong>10.</strong>	. Cabana Capitals may reject Client Welcome Bonus Promotion application(s) at any time
...
other marketing purposes.
                    ...
                    <h4 className='text-bold title_loss2'>
                    <strong>12.</strong>		Cabana Capitals reserves the right to disqualify any user, if there is a suspicion of misuse or
abuse of fair rules</h4>
                    <h4 className='text-bold title_loss2'>
                    <strong>13.</strong>		Cabana Capitals may cancel a client's bonus at any time without prior notification.</h4>
                    <h4 className='text-bold title_loss2'>
                    <strong>14.</strong>		Any situation not described in these rules shall be subject to the Company's decision.</h4>
                    <h4 className='text-bold title_loss2'>
                    <strong>15.</strong>	Cabana Capitals reserves the right to change, update or cancel this promotion without any
prior notification.	</h4>
                    <h4 className='text-bold title_loss2'>
                    <strong>16.</strong>		Cabana Capitals reserves the right to alter, amend or terminate the “Welcome Bonus
