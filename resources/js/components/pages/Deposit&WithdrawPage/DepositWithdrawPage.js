...
Trade the markets from Any Desktop, Android and IOS. Carry</p>
        <div className="">
          <button onClick={()=>{ window.open('https://secure.cabana-global.com/register/','_self')}} className="depositButton mr-0 mr-md-5 mb-3 mb-md-0">Open Live Account</button>
          <button onClick={()=>{ window.open('https://secure.cabana-global.com/register/','_self')}} className="depositButton">Open Demo Account</button>
        </div>
      </div>
