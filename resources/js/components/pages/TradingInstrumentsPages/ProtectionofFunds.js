...
class ProtectionofFunds extends Component {
    render() {
        ...
        />
                ...
                />
                <TradingInstrumentLeft
                title="3D secure Visa Authorization"
                text="We apply 3D secure technology when processing credit and debit cards. This technology makes all Visa transactions transparent and safe..                "
                imgUrl="/assets/images/Layer-13.png"
                // learnMoreLink="/comodoties"
                />
                <TradingInstrumentRight
