...
export default class TradingCurrenciesPairs extends Component {
  render() {
    return (
      <div>
          ...
          <div className="row basicRow">
            <div className="col-12 text-center">
              ...
              <p className="aboutDetailText">
                ...
                order execution on 45 popular currency pairs backed by some of
                the best liquidity providers in a modern, safe, technology
