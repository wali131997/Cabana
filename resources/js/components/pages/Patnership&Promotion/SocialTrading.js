        ...
        return (
            <div id="social">
                ...
                <div className="social_bg">
                    <div>
                        <div className='title_'><span className='titleLg'>COPY TRADING  </span><br /></div>
                ...
                <div className="">
                    <div className="container">
                        <div className="text-center mt-5">
                            <h2 className="stitle ">MT4 COPY TRADING</h2>
                            ...
                            <button onClick={() => { window.open('https://social.cabanacapitals.com/portal/login', '_self') }} className="btn download_mmt4 mt-5">START COPY TRADING NOW</button>
